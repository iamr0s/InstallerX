...
data class XMLEndNamespace(
    ...
    companion object {
        fun build(repo: ReaderRepo, headerOrNull: XMLTreeNodeHeader? = null): XMLEndNamespace {
            val header = headerOrNull ?: XMLTreeNodeHeader.build(repo)
            ChunkTypeUseError.check(ChunkHeader.Type.XML_END_NAMESPACE, header.type)
